                ...
                {StudyResourceImages.map((StudyResource,index)=>(
                  <Link to={StudyResource.link}>
                    <div key={index} className="relative flex justify-center items-center flex-col opacity-[0.5] hover:opacity-100 cursor-pointer group">
                      ...
                      <div className="absolute top-2 right-10 md:right-24 xl:right-44 text-2xl font-bold transition-transform ease-in-out transform group-hover:translate-x-4 translate-x-0"><FaArrowRight className="md:display-none"/></div>
