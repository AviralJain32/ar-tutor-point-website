...
const TestimonialCard = () => {
    return (
      <div className="relative md:max-w-[25rem] max-w-sm px-8 py-6 bg-white rounded-lg shadow-md mx-4 flex-shrink-0 ">
          ...
          <div className="flex items-center justify-between mt-8">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <div className="font-bold text-gray-900 cursor-pointer" tabIndex="0" role="link">
                  Aviral Jain
                </div>
                <div className="text-gray-600 cursor-pointer" tabIndex="0" role="link">
                  Science 2022 Batch
                </div>
              </div>
            </div>
