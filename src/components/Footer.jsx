          ...
          <div>
            ...
            <ul className="mt-2 font-extralight text-gray-300 text-sm cursor-pointer">
              <li className="flex gap-2 items-center py-1 hover:underline ">
                <MdLocationOn />
                <p>
                  B-9 Gururamdas nagar, Laxmi Nagar, <br></br>Balaji Rasoi,
                  Delhi-110092
                </p>
              </li>
              <li className="flex gap-2 items-center py-1 ">
                ...
                <p className="hover:underline">
                  <a href="callto:+91971-648-2969">9716482969</a>
                </p>
                <p className="hover:underline">
                  <a href="callto:+91958-252-4208">9582524208</a>
                </p>
                <p className="hover:underline">
                  <a href="callto:+91920-551-5818">9205515818</a>
                </p>
              </li>
              <li className="flex gap-2 items-center py-1 hover:underline">
                <MdMail />
                <p>
                  <a href="mailto:artutorspoint.info@gmail.com">
                    artutorspoint.info@gmail.com
                  </a>
                </p>
              </li>
            </ul>
          ...
          <div>
            <div>
              ...
              <ul className="mt-2 font-extralight text-sm cursor-pointer">
                <li className="flex gap-2 items-center py-1 hover:underline text-xl">
                  <a
                    href="https://www.instagram.com/artutorspoint?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                    target="_blank"
                  >
                    <IoLogoInstagram />
                  </a>
                  <a
                    href="https://www.facebook.com/people/A-R-Tutors-Point/pfbid0Uazu1pMpvHyMmdGAphUM8qykgoWwDjk9npkKzKiJU5G1X3WuEKFWLEGkEnYdrTiyl/?mibextid=ZbWKwL"
                    target="_blank"
                  >
                    <IoLogoFacebook />
                  </a>
            ...
            <div className="mt-2">
              ...
              <a href="https://www.youtube.com/@artutorspoint" target="_blank">
                <button className="bg-[#BB1D1D] mt-2 px-4 py-2 rounded-md text-[12px] flex items-center justify-center gap-2">
